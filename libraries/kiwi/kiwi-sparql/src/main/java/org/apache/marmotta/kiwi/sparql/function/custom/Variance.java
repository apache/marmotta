 ...
 */
public class Variance extends AggregationFunction implements NativeFunction {
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        if(dialect instanceof PostgreSQLDialect) {
            ...
            return String.format("VAR_POP(%s)", args[0]);
        } else if(dialect instanceof MySQLDialect) {
            return String.format("VARIANCE(%s)", args[0]);

        }
        throw new UnsupportedOperationException("VARIANCE not supported by dialect "+dialect);
    }
    ...
    public String getURI() {
        return FN_MARMOTTA.VARIANCE.stringValue();
    }
