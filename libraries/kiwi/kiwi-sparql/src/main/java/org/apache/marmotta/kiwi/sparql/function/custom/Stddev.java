 ...
 */
public class Stddev extends AggregationFunction implements NativeFunction {
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        if(dialect instanceof PostgreSQLDialect) {
            ...
            return String.format("STDDEV_POP(%s)", args[0]);
        } else if(dialect instanceof MySQLDialect) {
            return String.format("STDDEV(%s)", args[0]);

        }
        throw new UnsupportedOperationException("STDDEV not supported by dialect "+dialect);
    }
    ...
    public String getURI() {
        return FN_MARMOTTA.STDDEV.stringValue();
    }
