...
public class ResourceWebServiceHelper {
    ...
    public static String buildContentLink(Resource resource, String mime, ConfigurationService configurationService) {
        ...
        if (mime != null) {
            b.append("<");
            // b.append(configurationService.getBaseIri() + "content/" + mime +
            // appendix);
    ...
    public static String buildMetaLinks(IRI resource, List<String> datamimes, ConfigurationService configurationService) {
        StringBuilder b = new StringBuilder();
        for (int i = 0; i < datamimes.size(); i++) {
            b.append("<");
            // b.append(configurationService.getBaseIri() + "meta/" +
    ...
    public static String buildResourceLink(Resource resource, String rel, String mime, ConfigurationService configurationService) {
        final String src = configurationService.getServerIri();
        final String base = configurationService.getBaseIri();
