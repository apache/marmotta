...
public final class IntArray implements Comparable<IntArray>, Serializable {
    ...
    public static final IntArray createSPOCKey(Resource subject, IRI property, Value object, Resource context){
    ...
    public static final IntArray createSPOCMaxKey(Resource subject, IRI property, Value object, Resource context){
    ...
    public static final IntArray createCSPOKey(Resource subject, IRI property, Value object, Resource context){
    ...
    public static final IntArray createCSPOMaxKey(Resource subject, IRI property, Value object, Resource context){
