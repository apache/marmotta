...
public interface Facading {
     ...
     * @return
     */
    <C extends Facade> C createFacade(Resource r, Class<C> type, IRI context);
    ...
    /**
     * Create an instance of C that facades the resource identified by the iri given as argument, using the @RDF
     ...
     * @return
     */
    <C extends Facade> C createFacade(String iri, Class<C> type);
     ...
     */
    <C extends Facade> boolean isFacadeable(Resource r, Class<C> type, IRI context);
     ...
     * @return
     */
    <C extends Facade> Collection<C> createFacade(Collection<? extends Resource> list, Class<C> type, IRI context);
}
