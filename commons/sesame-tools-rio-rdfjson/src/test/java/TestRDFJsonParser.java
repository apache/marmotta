...
public class TestRDFJsonParser {
    ...
    public void runTest() throws Exception {
        ...
        InputStream rdfJSON = this.getClass().getResourceAsStream("testfiles/"+fileName+".json");
        InputStream rdfXML = this.getClass().getResourceAsStream("testfiles/"+fileName+".rdf");
